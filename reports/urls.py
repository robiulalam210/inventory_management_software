...
from .views import StockReportView, ExpenseReportView  # import from reports.views, not expenses.views
urlpatterns = [
    ...
    path('expense/', ExpenseReportView.as_view(), name='expense-report'),  # new endpoint
