...
class Company(models.Model):
    ...
    fiscal_year_start = models.DateField(default=date(date.today().year, 7, 1))  # July 1
    ...
    def save(self, *args, **kwargs):
        ...
        # Set default expiry date (1 year from start)
...
class User(AbstractUser):
    ...
    def get_permissions(self):
        """Return user permissions as dictionary"""
        return {
...
class Staff(models.Model):
    ...
    def total_compensation(self):
        """Calculate total compensation (salary + commission + bonus)"""
