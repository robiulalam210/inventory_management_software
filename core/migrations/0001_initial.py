# Generated by Django 5.2.7 on 2026-01-25 07:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fiscal_year_start', models.DateField(default=datetime.date(2026, 7, 1))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role_type', models.CharField(choices=[('management', 'Management'), ('sales', 'Sales'), ('warehouse', 'Warehouse'), ('accounts', 'Accounts'), ('support', 'Support'), ('custom', 'Custom')], default='custom', max_length=20)),
                ('description', models.TextField(blank=True, null=True)),
                ('default_permissions', models.JSONField(blank=True, default=dict)),
                ('is_active', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='staff_roles', to='core.company')),
            ],
            options={
