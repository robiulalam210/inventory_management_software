    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='staffs', to='core.company')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='staff', to=settings.AUTH_USER_MODEL)),
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='members', to='core.staffrole')),
            ],
            options={
                'indexes': [models.Index(fields=['status'], name='core_staff_status_844eba_idx'), models.Index(fields=['is_main_user'], name='core_staff_is_main_a3a8ea_idx')],
            },
        ),
    ]
