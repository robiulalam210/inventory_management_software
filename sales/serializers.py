...
class SaleItemSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        if qty > product.stock_qty:
            raise serializers.ValidationError(f"Not enough stock for {product.name}. Available: {product.stock_qty}")
        return attrs

    # Decrement stock when creating sale item
